...
export interface ClassStatement extends BaseStmt
{
    type: 'ClassStatement';
    name: Identifier;
    params: (Identifier | PromotedParameter)[]; // Primary constructor parameters
...
export interface PromotedParameter extends BaseExpr {
    type: 'PromotedParameter';
    value: string; // The name of the parameter (and the property)
}
